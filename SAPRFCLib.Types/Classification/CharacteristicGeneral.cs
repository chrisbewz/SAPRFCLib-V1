...
public interface ICharacteristicContainer
    {
        IEnumerable<CharacteristicDescriptions> Description { get; set; }

        IEnumerable<References> Reference { get; set; }

        IEnumerable<Restrictions> Restriction { get; set; }

        IEnumerable<CharValues> CharValue { get; set; }

        IEnumerable<NumValues> NumericalValue { get; set; }

        IEnumerable<Details> General { get; set; }

        IEnumerable<ValueDescriptions> ValDescriptions { get; set; }
    }

    public class CharacteristicInformationStructure : ICharacteristicContainer
    {

        [Aliases("descriptions", "desc")]
        [Description("CharacteristicInformation fields individual descriptions")]
        public IEnumerable<CharacteristicDescriptions> Description { get; set; }

        [Aliases("references", "ref", "refs")]
        [Description("SAP check table and field for characteristic")]
        public IEnumerable<References> Reference { get; set; }

        [Aliases("restrictions", "restrict")]
        [Description("Restricted values for characteristic")]
        public IEnumerable<Restrictions> Restriction { get; set; }

        [Aliases("charvalues", "charval")]
        [Description("CHAR ABAP type fields and it's values in characteristic information")]
        public IEnumerable<CharValues> CharValue { get; set; }

        [Aliases("numvalues", "numval")]
        [Description("NUMERICAL ABAP type fields and it's values in characteristic information")]
        public IEnumerable<NumValues> NumericalValue { get; set; }

        [Aliases("generaldetails", "details")]
        [Description("CharacteristicInformation specific properties")]
        public IEnumerable<Details> General { get; set; }

        [Aliases("valuedescriptions", "valdescriptions")]
        [Description("CharacteristicInformation individual value descriptions")]
        public IEnumerable<ValueDescriptions> ValDescriptions { get; set; }
